...
public typealias N50 = Plus<W2, Plus<W16, W32>>
...
public enum SameStanding<PaperLit, RoleLit, RoleDim, PaperDim, Slack>: Close {}
extension SameStanding: Standing
where Times<Plus<PaperLit, N50>, Plus<PaperDim, N50>>
      == Plus<Times<Plus<RoleLit, N50>, Plus<RoleDim, N50>>, Slack> {}
...
public typealias InkDimX = Plus<Unit, Plus<W2, Plus<W32, Plus<W128, Plus<W256, W512>>>>>
public typealias InkDimY = Plus<W4, Plus<W16, Plus<W64, Plus<W128, Plus<W256, W512>>>>>
public typealias InkDimZ = Plus<Unit, Plus<W2, Plus<W8, Plus<W32, W1024>>>>
...
public typealias MutedDimX = Plus<Unit, Plus<W2, Plus<W8, Plus<W16, W128>>>>
public typealias MutedDimY = Plus<Unit, Plus<W2, Plus<W32, W128>>>
public typealias MutedDimZ = Plus<Unit, Plus<W16, Plus<W32, W128>>>
public typealias OkDimX = Plus<W2, Plus<W4, Plus<W8, W128>>>
public typealias OkDimY = Plus<Unit, Plus<W2, W256>>
public typealias OkDimZ = Plus<W8, Plus<W32, W64>>
public typealias BadDimX = Plus<Unit, Plus<W4, Plus<W8, Plus<W16, W256>>>>
public typealias BadDimY = Plus<Unit, Plus<W2, W256>>
public typealias BadDimZ = Plus<Unit, Plus<W4, Plus<W8, Plus<W32, Plus<W64, W128>>>>>
public typealias ActionDimX = Plus<Unit, Plus<W2, Plus<W4, Plus<W8, Plus<W16, Plus<W32, Plus<W64, W128>>>>>>>
public typealias ActionDimY = Plus<Unit, Plus<W2, W256>>
public typealias ActionDimZ = Plus<W4, Plus<W16, Plus<W32, Plus<W128, W256>>>>
public typealias LawDimX = Plus<Unit, Plus<W8, Plus<W16, W256>>>
public typealias LawDimY = Plus<Unit, Plus<W2, W256>>
public typealias LawDimZ = Plus<W2, Plus<W64, W128>>
public typealias LocalTypeDimX = Plus<W2, Plus<W4, Plus<W8, Plus<W16, Plus<W32, W128>>>>>
public typealias LocalTypeDimY = Plus<Unit, Plus<W2, W256>>
public typealias LocalTypeDimZ = Plus<W2, Plus<W4, Plus<W16, Plus<W128, W256>>>>
public typealias KnownNameDimX = Plus<Unit, Plus<W8, Plus<W16, W256>>>
public typealias KnownNameDimY = Plus<Unit, Plus<W2, W256>>
public typealias KnownNameDimZ = Plus<Unit, Plus<W2, Plus<W8, Plus<W32, Plus<W128, W256>>>>>
public typealias SeamDimX = Plus<Unit, Plus<W4, Plus<W8, Plus<W16, Plus<W32, W64>>>>>
public typealias SeamDimY = Plus<Unit, Plus<W2, W128>>
public typealias SeamDimZ = Plus<Unit, Plus<W2, Plus<W4, Plus<W8, W128>>>>
...
public typealias InkOverMuted_dim = Brighter<InkDimY, MutedDimY, Plus<W16, Plus<W32, Plus<W256, W512>>>>
public typealias MutedOverLine_dim = Brighter<MutedDimY, LineDimY, Plus<W16, Plus<W32, W64>>>
...
public typealias Ink_Paper_dim = Legible<InkDimY, PaperDimY, Plus<W2, Plus<W32, Plus<W64, W512>>>>
public typealias Muted_Paper_dim = Readable<MutedDimY, PaperDimY, Plus<Unit, W32>>
public typealias Ok_Paper_dim = ReadableAA<OkDimY, PaperDimY, Plus<W2, Plus<W4, Plus<W8, W64>>>>
public typealias Bad_Paper_dim = ReadableAA<BadDimY, PaperDimY, Plus<W2, Plus<W4, Plus<W8, W64>>>>
public typealias Action_Paper_dim = ReadableAA<ActionDimY, PaperDimY, Plus<W2, Plus<W4, Plus<W8, W64>>>>
public typealias Law_Paper_dim = ReadableAA<LawDimY, PaperDimY, Plus<W2, Plus<W4, Plus<W8, W64>>>>
public typealias LocalType_Paper_dim = ReadableAA<LocalTypeDimY, PaperDimY, Plus<W2, Plus<W4, Plus<W8, W64>>>>
public typealias KnownName_Paper_dim = ReadableAA<KnownNameDimY, PaperDimY, Plus<W2, Plus<W4, Plus<W8, W64>>>>
...
public typealias InkGrey_dim = Grey<InkDimX, InkDimY, InkDimZ, Plus<Unit, Plus<W2, Plus<W4, Plus<W16, Plus<W64, W128>>>>>, Plus<Unit, Plus<W4, Plus<W8, Plus<W16, Plus<W32, Plus<W64, Plus<W128, W512>>>>>>>, Plus<Unit, Plus<W2, Plus<W4, Plus<W8, Plus<W16, Plus<W64, Plus<W128, W512>>>>>>>, Plus<Unit, Plus<W4, Plus<W16, Plus<W32, Plus<W64, W128>>>>>>
...
public typealias MutedGrey_dim = Grey<MutedDimX, MutedDimY, MutedDimZ, Plus<W8, W16>, Plus<Unit, Plus<W2, Plus<W8, W128>>>, Plus<W2, Plus<W4, Plus<W8, Plus<W16, Plus<W32, W64>>>>>, Plus<Unit, Plus<W4, W32>>>
public typealias SeamGrey_dim = Grey<SeamDimX, SeamDimY, SeamDimZ, Plus<W2, Plus<W4, W32>>, Plus<Unit, Plus<W4, Plus<W8, Plus<W16, W64>>>>, Plus<W16, Plus<W32, W64>>, Plus<Unit, Plus<W2, W16>>>
...
public typealias OkChroma_dim = TowardWarm<OkDimY, OkDimZ, Plus<W8, Plus<W32, Plus<W256, W4096>>>>
public typealias BadChroma_dim = TowardWarm<BadDimY, BadDimZ, Plus<Unit, Plus<W2, Plus<W8, Plus<W32, W1024>>>>>
public typealias ActionChroma_dim = TowardBlue<ActionDimY, ActionDimZ, Plus<Unit, Plus<W2, Plus<W4, Plus<W8, Plus<W16, Plus<W32, Plus<W512, Plus<W1024, W2048>>>>>>>>>
public typealias LawChroma_dim = TowardWarm<LawDimY, LawDimZ, Plus<W2, Plus<W4, Plus<W8, Plus<W16, Plus<W64, W2048>>>>>>
public typealias LocalTypeChroma_dim = TowardBlue<LocalTypeDimY, LocalTypeDimZ, Plus<Unit, Plus<W16, Plus<W64, Plus<W256, Plus<W512, W2048>>>>>>
public typealias KnownNameChroma_dim = TowardBlue<KnownNameDimY, KnownNameDimZ, Plus<W2, Plus<W4, Plus<W8, Plus<W16, Plus<W64, Plus<W256, Plus<W1024, W2048>>>>>>>>
...
public typealias VerdictPoles_dim = Opposed<OkDimX, OkDimY, BadDimX, BadDimY, Plus<W4, Plus<W16, Plus<W32, W64>>>, Plus<Unit, Plus<W8, W16>>>
...
public typealias Seam_Paper_dim = Readable<SeamDimY, PaperDimY, Unit>
public typealias SeamUnderMuted_lit = Brighter<SeamLitY, MutedLitY, Plus<Unit, Plus<W16, W32>>>
public typealias SeamUnderMuted_dim = Brighter<MutedDimY, SeamDimY, Plus<Unit, Plus<W2, Plus<W4, Plus<W8, W16>>>>>
...
// ── and a role stands as loud on one canvas as on the other: the light
// theme's own contrast is the bound the dark rung answers to, so a theme
// cannot drift into shouting while the other whispers ──
public typealias InkStands = SameStanding<PaperLitY, InkLitY, InkDimY, PaperDimY, Never>
public typealias MutedStands = SameStanding<PaperLitY, MutedLitY, MutedDimY, PaperDimY, Plus<W2, Plus<W4, Plus<W8, W16>>>>
public typealias SeamStands = SameStanding<PaperLitY, SeamLitY, SeamDimY, PaperDimY, Plus<W4, W256>>
public typealias OkStands = SameStanding<PaperLitY, OkLitY, OkDimY, PaperDimY, Never>
public typealias BadStands = SameStanding<PaperLitY, BadLitY, BadDimY, PaperDimY, Never>
public typealias ActionStands = SameStanding<PaperLitY, ActionLitY, ActionDimY, PaperDimY, Never>
public typealias LawStands = SameStanding<PaperLitY, LawLitY, LawDimY, PaperDimY, Never>
public typealias LocalTypeStands = SameStanding<PaperLitY, LocalTypeLitY, LocalTypeDimY, PaperDimY, Never>
public typealias KnownNameStands = SameStanding<PaperLitY, KnownNameLitY, KnownNameDimY, PaperDimY, Never>
